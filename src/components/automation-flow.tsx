...
import { MessageSquare, Cpu, Database, Calendar, Mail, CheckCircle2, ArrowRight } from "lucide-react";

const OUTPUT_NODES = [
  { icon: Database, label: "CRM",          sub: "Lead registrado",  from: "from-violet-500", to: "to-purple-500",  glow: "shadow-violet-500/40",  border: "border-violet-500/30"  },
  { icon: Calendar, label: "Calendario",   sub: "Cita agendada",    from: "from-pink-500",   to: "to-rose-500",    glow: "shadow-pink-500/40",    border: "border-pink-500/30"    },
  { icon: Mail,     label: "Notificación", sub: "Email enviado",    from: "from-orange-500", to: "to-amber-500",   glow: "shadow-orange-500/40",  border: "border-orange-500/30"  },
];
...
function MainNode({
  icon: Icon, label, sub, gradient, glow, active, pulsing, processing,
}: {
  icon: any; label: string; sub: string; gradient: string; glow: string;
...
function OutputNode({
  icon: Icon, label, sub, gradient, border, glow, visible, done, delay,
}: {
  icon: any; label: string; sub: string; gradient: string; border: string; glow: string;
