  ...
  return (
    <main className="min-h-screen bg-background text-foreground flex flex-col">
      ...
      <div className="relative w-full isolate z-0">
        ...
        <div className="absolute top-0 left-0 w-full h-[450px] bg-gradient-to-br from-blue-700 via-blue-600 to-[#1d4ed8] rounded-b-[40px] md:rounded-b-[80px] -z-10 overflow-hidden">
        ...
        <div className="pt-40 pb-[80px] px-6 max-w-7xl mx-auto text-center">
          ...
          <p className="text-blue-100/90 max-w-2xl mx-auto text-lg md:text-xl font-medium leading-relaxed">
        ...
        <div className="max-w-7xl mx-auto px-6 mt-24 mb-20 relative z-10">
          {error ? (
